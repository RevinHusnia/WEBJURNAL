        ...
        <div class="bottom-bar">
            <ul>
                <li><a href="/pages/home.php" id="home"><img src="/assets/home.png" alt="Home Icon"></a></li>
                <li><a href="/pages/total_hadir.php" id="total-hadir"><img src="/assets/immigration.png" alt="Total Hadir Icon"></a></li>
